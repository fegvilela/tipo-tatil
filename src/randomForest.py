...
# the data and label lists
    ...
    data = []
    labels = []
    desc = LocalBinaryPatterns(21, 9) # LBP 21 pontos e raio 9 = melhor acurácia
    ...
    modelRFC = RandomForestClassifier(n_estimators = 82, n_jobs = -1)
    ...
    file1.write("Accuracy RFC: %0.4f (+/- %0.2f) \n" % (resultRFC.mean(), resultRFC.std() * 2))
    resultsList.append(resultRFC.mean())
    #print do resultado
    print("Accuracy RFC: %0.4f (+/- %0.2f)" % (resultRFC.mean(), resultRFC.std() * 2))
